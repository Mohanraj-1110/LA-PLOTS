...
export function ReportsPage() {
  ...
  const handleExportExcel = () => {
    const rows = getReportRows();
    reportService.exportToExcel(`LA_PLOTS_${activeTab}_Report`, rows);
    success(`Exported ${activeTab} report to Excel (.xlsx)`);
  };

  const handleExportPdf = () => {
    const rows = getReportRows();
    reportService.exportToPdf(`LA PLOTS - ${activeTab.toUpperCase()} Report`, rows, `LA_PLOTS_${activeTab}_Report`);
    success(`Exported ${activeTab} report to PDF`);
  };
