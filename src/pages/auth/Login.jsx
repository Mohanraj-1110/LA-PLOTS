      ...
      <div className="w-full max-w-md animate-slide-up relative z-10">
        <div className="rounded-3xl bg-white/95 backdrop-blur-xl p-8 shadow-elevated border border-white/20">
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="mt-5 text-2xl font-bold text-surface-900 font-display">Welcome back</h1>
            <p className="mt-1.5 text-sm text-surface-500">Sign in to access your account</p>
          </div>
          ...
          <div className="my-5 flex items-center gap-3">
            ...
            <span className="text-xs font-semibold text-surface-400 uppercase tracking-wider">or sign in with email</span>
            <div className="flex-1 border-t border-surface-200" />
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <Link to="/forgot-password" tabIndex={-1} className="text-xs font-bold text-primary-600 hover:text-primary-700 transition-colors">
                  Forgot?
                </Link>
              </div>
              <input
