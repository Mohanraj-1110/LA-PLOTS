...
export function LoginPage() {
  ...
  // If already authenticated and visiting /login directly, redirect to proper portal
  useEffect(() => {
  ...
  const onSignUpSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      const result = await signup(cleanName, cleanEmail, signupPassword, signupRole);
      ...
      const userRole = (result?.profile?.role || signupRole).toLowerCase();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 flex items-center justify-center p-4 sm:p-6 lg:p-10 relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl bg-white/95 backdrop-blur-2xl rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 border border-white/20 relative z-10">
        ...
        <div className="hidden lg:flex lg:col-span-5 relative bg-gradient-to-br from-slate-950 via-emerald-950 to-slate-900 p-10 text-white flex-col justify-between overflow-hidden border-r border-emerald-900/40">
          ...
          <div className="relative z-10">
            <Link to="/" className="inline-flex items-center gap-3 group">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-emerald-600 to-teal-400 text-white flex items-center justify-center shadow-lg shadow-emerald-500/30 group-hover:scale-105 transition-transform duration-300">
                <span className="font-black text-xl tracking-tight">LK</span>
              </div>
              <div>
                <h1 className="text-xl font-black tracking-tight text-white leading-none font-display">
                  LK PROPERTIES
                </h1>
                <p className="text-[11px] text-emerald-400 font-bold tracking-wider uppercase mt-1">
                  Verified Land & Plots
                </p>
              </div>
            </Link>
            ...
            <div className="mt-12 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/15 text-emerald-300 text-xs font-semibold border border-emerald-500/30 backdrop-blur-md">
                <Sparkles className="w-3.5 h-3.5 text-emerald-400" /> DTCP & RERA Approved Layouts
              </div>

              <h2 className="text-3xl font-extrabold tracking-tight leading-snug font-display text-white">
                Invest with Confidence in Verified Plotted Communities.
              </h2>
          ...
          <div className="relative z-10 pt-8 border-t border-emerald-900/60">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="p-2.5 rounded-xl bg-white/5 border border-white/10 backdrop-blur-xs">
                ...
                <p className="text-[10px] text-emerald-400 font-semibold mt-1 uppercase">Plots Available</p>
              </div>
              <div className="p-2.5 rounded-xl bg-white/5 border border-white/10 backdrop-blur-xs">
                <p className="text-xl font-black text-white leading-none">100%</p>
                <p className="text-[10px] text-emerald-400 font-semibold mt-1 uppercase">Clear Titles</p>
              </div>
              <div className="p-2.5 rounded-xl bg-white/5 border border-white/10 backdrop-blur-xs">
                <p className="text-xl font-black text-white leading-none">15k+</p>
                <p className="text-[10px] text-emerald-400 font-semibold mt-1 uppercase">Happy Clients</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 p-6 sm:p-10 lg:p-12 flex flex-col justify-center bg-white">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-emerald-600 to-teal-500 text-white flex items-center justify-center shadow-md font-black text-sm">
              LK
            </div>
            <div>
              <h1 className="text-lg font-black text-slate-900 tracking-tight leading-none font-display">
                LK PROPERTIES
              </h1>
          ...
          <div className="flex p-1.5 bg-slate-100/90 rounded-2xl mb-6 border border-slate-200/80">
            <button
              ...
              className={`flex-1 py-2.5 text-xs font-extrabold rounded-xl transition-all duration-200 cursor-pointer ${mode === 'signin'
            ...
            <button
              ...
              className={`flex-1 py-2.5 text-xs font-extrabold rounded-xl transition-all duration-200 cursor-pointer ${mode === 'signup'
          ...
          {/* On-Form Error Alert Banner */}
          {authError && (
            <div className="mb-5 p-3.5 rounded-2xl bg-rose-50 border border-rose-200 text-rose-800 flex items-start justify-between gap-3 animate-slide-up shadow-xs">
          ...
          {authSuccessMsg && (
            <div className="mb-5 p-3.5 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-800 flex items-center gap-2.5 animate-slide-up shadow-xs">
          ...
          {mode === 'signin' ? (
            <div>
              ...
              <form onSubmit={handleSubmit(onSignInSubmit)} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-3.5 py-2.5 rounded-xl border text-xs font-medium text-slate-800 placeholder:text-slate-400 bg-white transition-all focus:outline-hidden focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 ${errors.emailOrPhone ? 'border-rose-400 bg-rose-50/20' : 'border-slate-200'
                        }`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className={`w-full pl-10 pr-10 py-2.5 rounded-xl border text-xs font-medium text-slate-800 placeholder:text-slate-400 bg-white transition-all focus:outline-hidden focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 ${errors.password ? 'border-rose-400 bg-rose-50/20' : 'border-slate-200'
                        }`}
                      {...register('password')}
                    />
                    <button
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full py-3 px-4 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white text-xs font-extrabold rounded-xl shadow-md shadow-emerald-600/20 hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-70 mt-2"
                >
                  {submitting ? (
                ...
                <button
                  ...
                  disabled={submitting}
                  className="w-full py-2.5 px-4 bg-white hover:bg-slate-50 text-slate-700 text-xs font-bold rounded-xl border border-slate-200/90 shadow-xs hover:shadow-sm transition-all flex items-center justify-center gap-2.5 cursor-pointer disabled:opacity-70"
                >
            ...
            <div>
              <div className="mb-5">
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Join LK PROPERTIES as a property buyer or registered field agent.
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <button
                      ...
                      className={`p-3 rounded-2xl border text-left transition-all cursor-pointer ${signupRole === 'customer'
                        ? 'bg-emerald-50/80 border-emerald-500 ring-2 ring-emerald-500/20'
                        : 'bg-white border-slate-200 hover:bg-slate-50'
                        }`}
                    >
                      <div className="flex items-center gap-2">
                        <div className={`w-6 h-6 rounded-lg flex items-center justify-center text-xs font-bold ${signupRole === 'customer' ? 'bg-emerald-600 text-white' : 'bg-slate-100 text-slate-500'
                          }`}>
                          <User className="w-3.5 h-3.5" />
                        </div>
                        <span className="text-xs font-bold text-slate-900">Buyer / Investor</span>
                      </div>
                      <p className="text-[10px] text-slate-500 mt-1 pl-8">
                        Browse plots, book visits, EMI planner
                      </p>
                    </button>
                    ...
                    <button
                      ...
                      className={`p-3 rounded-2xl border text-left transition-all cursor-pointer ${signupRole === 'agent'
                        ? 'bg-teal-50/80 border-teal-500 ring-2 ring-teal-500/20'
                        : 'bg-white border-slate-200 hover:bg-slate-50'
                        }`}
                    >
                      <div className="flex items-center gap-2">
                        <div className={`w-6 h-6 rounded-lg flex items-center justify-center text-xs font-bold ${signupRole === 'agent' ? 'bg-teal-600 text-white' : 'bg-slate-100 text-slate-500'
                          }`}>
                      ...
                      <p className="text-[10px] text-slate-500 mt-1 pl-8">
                        Manage plots, client leads & visits
                      </p>
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3.5 py-2.5 rounded-xl border border-slate-200 text-xs font-medium text-slate-800 placeholder:text-slate-400 bg-white transition-all focus:outline-hidden focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full pl-10 pr-10 py-2.5 rounded-xl border border-slate-200 text-xs font-medium text-slate-800 placeholder:text-slate-400 bg-white transition-all focus:outline-hidden focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500"
                    />
                    <button
                      type="button"
